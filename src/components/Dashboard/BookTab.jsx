  ...
  return (
    <div className="bg-gradient-to-br from-white to-[#FAF9F7] rounded-2xl p-8 border border-gray-200/50 shadow-lg hover:shadow-xl transition-all">
      ...
      <p className="text-gray-600 mb-8 leading-relaxed">
        {t({ en: "Select a class type and time that works for you.", es: "Selecciona un tipo de clase y horario que te funcione." })}
      </p>
      <a
        href="/book"
      ...
      >
        <Calendar size={20} />
        <span>{t({ en: "Go to booking page", es: "Ir a la página de reservas" })}</span>
      </a>
    </div>
  );
}
