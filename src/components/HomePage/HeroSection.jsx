      ...
      <div className="relative flex items-center min-h-[92vh]">
        ...
        <div className="hidden lg:block absolute top-0 right-0 w-[55%] h-full">
          <img
            ...
            fetchPriority="high"
          />
          {/* Cinematic gradient: left fade into dark bg */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0c1a2e] via-[#0c1a2e]/70 to-transparent" />
          {/* Subtle bottom fade */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#0c1a2e]/50 to-transparent" />
          {/* Warm cinematic tone */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 w-full py-10 lg:py-20">
          <div className="max-w-xl lg:max-w-[540px]">
            ...
            {/* Club badge */}
            <div className="inline-flex items-center gap-2.5 bg-white/[0.08] backdrop-blur-md rounded-full px-5 py-2 border border-white/[0.08] mb-7">
              <span className="w-2 h-2 rounded-full bg-[#f97316] animate-pulse" />
              <span className="text-[13px] font-semibold text-[#f97316] tracking-widest uppercase">
                {t({ en: "English Speaking Club", es: "Club de Conversación en Inglés" })}
              </span>
            </div>

            {/* Headline */}
            <h1 className="font-poppins text-[2.5rem] sm:text-5xl lg:text-[3.5rem] xl:text-6xl font-extrabold leading-[1.08] mb-6 tracking-tight">
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl text-slate-300/90 leading-relaxed mb-9 max-w-md">
              {t({
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-10">
              <Link
                to="/account/signup"
                className="group inline-flex items-center justify-center px-7 py-4 bg-gradient-to-r from-[#ea580c] to-[#f97316] text-white rounded-xl font-bold text-[15px] shadow-lg shadow-orange-600/25 hover:shadow-xl hover:shadow-orange-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
              ...
              <Link
                to="#programs"
                className="inline-flex items-center justify-center px-7 py-4 bg-transparent border border-white/20 text-white rounded-xl font-semibold text-[15px] hover:bg-white/[0.06] transition-all"
              >
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-lg bg-[#f97316]/10 flex items-center justify-center">
                    <stat.icon size={16} className="text-[#f97316]" />
                  </div>
                  <div>
                    <p className="text-white font-bold text-sm leading-tight">{stat.value}</p>
                    <p className="text-slate-400 text-[11px] font-medium">{stat.label}</p>
                  </div>
