...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="w-full bg-[#FAF9F7]/95 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-3 min-h-[44px] min-w-[44px] flex items-center justify-center text-[#1F2A44] hover:bg-[#1F2A44]/5 rounded-xl transition-colors relative z-[60]"
      ...
      {/* Mobile menu overlay — OUTSIDE header to avoid backdrop-filter containment on iOS */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 top-16 sm:top-20 bg-[#FAF9F7] z-[55] md:hidden overflow-y-auto">
